...
## Conference papers
+ (**New**) Anastasios Kyrillidis, Bubacarr Bah, Rouzbeh Hasheminezhad, Quoc Tran-Dinh, Luca Baldassarre, and Volkan Cevher, [*``Convex block-sparse linear regression with expanders, provably"*](), AI & Statistics Conference (AISTATS), 2016.
+ (**New**) Hemant Tyagi, Anastasios Kyrillidis, Bernd G\\a"rtner, and Andreas Krause, [*``Learning sparse additive models with interactions in high dimensions"*](), AI & Statistics Conference (AISTATS), 2016.
+ (**New**) Megasthenis Asteris, Anastasios Kyrillidis, Dimitris Papailiopoulos, and Alex Dimakis, [*``Bipartite correlation clustering -- Maximizing agreements"*](), AI & Statistics Conference (AISTATS), 2016.
